  ...
  return (
    <div className="bg-[#F4F3F0] min-h-screen flex flex-col items-center py-10 px-4">
      ...
      <div className="bg-[#F4F3F0] w-full max-w-4xl rounded-xl shadow-md p-10">
        ...
        {/* ✅ Your full form with all fields */}
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Chef */}
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700">Chef</label>
            <input
              name="chef"
              type="text"
          ...
          {/* Taste */}
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700">Taste</label>
            <input
              name="taste"
              type="text"
